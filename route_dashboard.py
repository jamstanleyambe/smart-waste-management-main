...
from popup_templates import bin_popup_html
...
def create_map(bins, dumping_spots, trucks, selected_bin=None, path=None, highlight_item=None, highlight_type=None):
    ...
    for bin in bins:
        ...
        popup_content = bin_popup_html(bin, is_searched=False)

        iframe = folium.IFrame(html=popup_content, width=310, height=580)
